...
struct CachingPartComposer<E: std::error::Error, Cache, Runtime: Spawn, Client: ObjectClient> {
...
impl<E, Cache, Runtime, Client> CachingPartComposer<E, Cache, Runtime, Client>
where
