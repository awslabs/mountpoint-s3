...
#[derive(Debug)]
pub struct ClientPartStream<Client, Runtime> {
    client: Arc<Client>,
    runtime: Runtime,
}

impl<Client, Runtime> ClientPartStream<Client, Runtime>
where
...
impl<Client, Runtime> ObjectPartStream for ClientPartStream<Client, Runtime>
where
    Client: ObjectClient + Send + Sync + 'static,
    Runtime: Spawn,
{
            ...
            async move {
                    ...
                    .await
                {
                    ...
                    Err(e) => {
                        ...
                        part_queue_producer.push(Err(PrefetchReadError::map(e)));
                        return;
                    }
                };
