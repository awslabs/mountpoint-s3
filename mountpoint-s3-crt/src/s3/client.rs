...
use super::pool::{CrtBufferPoolFactory, MemoryPoolWrapper};
...
pub struct ClientConfig {
    ...
    /// Holds the custom pool implementation if set.
    pool: Option<Arc<MemoryPoolWrapper>>,
}
...
impl ClientConfig {
    ...
    pub fn buffer_pool_factory(&mut self, pool_factory: CrtBufferPoolFactory) -> &mut Self {
        let (factory_fn, user_data, pool) = pool_factory.into_inner();
