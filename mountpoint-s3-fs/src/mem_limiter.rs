...
impl MemoryLimiter {
    ...
    pub fn try_reserve(&self, area: BufferArea, size: u64) -> bool {
        ...
        loop {
            ...
            let client_mem_allocated = self.pool_mem_allocated();
    ...
    // TODO: Get allocated memory for the client. Currently, only the CRT client is able to report its buffer pool stats.
    ...
    fn pool_mem_allocated(&self) -> u64 {
        self.pool.bytes_in_use_excluding_prefetch() as u64
    }
}
