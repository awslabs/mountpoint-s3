...
* File mode will be a default value (`0755` for directories, `0644` for files) unless you manually configure them with the `--dir-mode` and `--file-mode` command-line arguments.
